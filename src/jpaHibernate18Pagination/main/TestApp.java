package jpaHibernate18Pagination.main;
...
import jpaHibernate18Pagination.model.Project;
import jpaHibernate18Pagination.util.HibernateUtil;
...
public class TestApp {
	...
	public static void main(String[] args) {
		...
		try {
			...
			List<Object[]> list = query.getResultList();// select pid,projName,company from Project where location = 'hyd'
